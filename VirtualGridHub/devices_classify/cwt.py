...
print("cheeropowerplus5 or cheeropowermountain or googlepixel3a or ipadair4th or xperiaxz2compact : ", end="")
device = input()

ROOT_DIR = f'/home/pi/Desktop/doyer/research/VirtualGridHub/devices_classify/eval_csv/dataset_{method}_20231024/cwt'
TARGET_PATTERN = "**.csv"
SAVEPATH = f'/home/pi/Desktop/doyer/research/VirtualGridHub/devices_classify/eval_cwt/dataset_{method}_20231024/{data_set}/{device}#1'
...
#CWTを画像で保存
def plot_cwt_save(cwtmatr_,SAVEPATH,FILENAME):
