...
void main(){
	...
	*/
	...
	VGHUBPD_STATUS sets1 = SetPortConfig(1,1,0,45);
	VGHUBPD_STATUS sets2 = SetPortConfig(2,1,0,30);
	VGHUBPD_STATUS sets3 = SetPortConfig(3,0,18,0);
	VGHUBPD_STATUS sets4 = SetPortConfig(4,0,18,0);
	VGHUBPD_STATUS sets5 = SetPortConfig(5,0,18,0);
	VGHUBPD_STATUS sets6 = SetPortConfig(6,0,18,0);

	sleep(1);
	
	printf("#### sSeted PortConfig ####\n");
	printf("---------------------\n");
	//ポート情報を取得
	for(i=0;i<N_PORT;i++){
