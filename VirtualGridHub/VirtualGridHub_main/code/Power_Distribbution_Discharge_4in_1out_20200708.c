...
void main(){
	...
	*/
	...
	VGHUBPD_STATUS sets0 = SetPortConfig(0,1,0,0);
	VGHUBPD_STATUS sets1 = SetPortConfig(1,1,0,0);
	VGHUBPD_STATUS sets2 = SetPortConfig(2,1,0,0);
	VGHUBPD_STATUS sets3 = SetPortConfig(3,1,0,0);
	VGHUBPD_STATUS sets4 = SetPortConfig(4,1,0,40);
